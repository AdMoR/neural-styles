...
p.add_argument("--layer_name", default=VGGLayers.Conv2_2, type=VGGLayers, choices=list(VGGLayers))
...
if __name__ == "__main__":
    ...
    print(namespace)
    run(namespace.n_paths, namespace.imsize, namespace.n_steps, namespace.layer_name, namespace.layer_index)
